using Tyuiu.BlagihIA.Sprint0.Task7.V0.Lib;
namespace Tyuiu.BlagihIA.Sprint0.Task7.V0
{
    internal class Program
    {
        static void Main(string[] args)
        {
            Console.Title = "Спринт #0 | Выполнил: Благих И.А | ИИПб-24-2";
            ...
            {
                Console.WriteLine("Ошибка! Исходные массивы имеют разное количество элементвов");
            }
            Console.ReadKey();
        }
    }
